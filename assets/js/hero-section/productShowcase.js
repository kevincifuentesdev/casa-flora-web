...
function createProductCard(product) {
    ...
    description.textContent = product.getProductDescription();

    const actionDiv = document.createElement("div");
    actionDiv.className = "product-action";

    const priceSpan = document.createElement("span");
    priceSpan.textContent = `$${product.getProductPrice().toLocaleString("es-CO")}`;
...
document.addEventListener("DOMContentLoaded", renderProductShowcase);
